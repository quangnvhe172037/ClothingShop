...
public class CategoryDAO extends DAO {
    ...
    public List<Category> getAllCate() {
        String sql = "select * from Category_HE170027";
    ...
    public Category getCategoryById(int id) {
        try {
            String sql = "select *  from Category_HE170027 where category_id = ?";
    ...
    public void insertCategory(String name) {
        try {
            String sql = "INSERT INTO [dbo].[Category_HE170027]\n"
                    + "           ([category_name])\n"
                    + "     VALUES\n"
                    + "           (?)";
            PreparedStatement stm = con.prepareStatement(sql);
    ...
    public void updateCategory(Category category) {
        try {
            String sql = "UPDATE [dbo].[Category_HE170027]\n"
                    + "   SET [category_name] = ?\n"
                    + " WHERE category_id = ?";
            PreparedStatement stm = con.prepareStatement(sql);
